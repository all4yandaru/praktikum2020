...
option_station <- unique(udara_bandung[["station"]]) # ngambil data2 yg unik
option_parameter <- colnames(udara_bandung)[-c(1, 2)] # ngambil nama kolom kecuali kolom ke 1 dan 2
```
